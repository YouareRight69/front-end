                            ...
                            <form id="form" onSubmit={onSubmit} style={{ textAlign: "left", color: "black", width: "80%" }}>
                                <div className="mt-10" style={{ 'display': 'flex' }}>
                                    ...
                                    <div className="col-lg-9 col-md-4">
                                        <input type="text" placeholder="Họ tên" onFocus="this.placeholder = ''"
                                            onBlur="this.placeholder = 'Họ tên'" required className="single-input"
                                ...
                                <div className="mt-10" style={{ 'display': 'flex' }}>
                                    ...
                                    <div className="col-lg-9 col-md-4">
                                        <input type="text" placeholder="Số điện thoại"
                                            ...
                                            required className="single-input" name='phoneNumber' onChange={(e) => handleChange(e)} id="phoneNumber" />
                                    </div>
                                </div>
                                <div className="mt-10" style={{ 'display': 'flex' }}>
                                    <div className="col-lg-3 col-md-4">
                                ...
                                <div className="mt-10" style={{ 'display': 'flex' }}>
                                    ...
                                    <div className="col-lg-9 col-md-4">
                                        <input type="email" placeholder="Email" onFocus="this.placeholder = ''"
                                            onBlur="this.placeholder = 'Email'" required className="single-input"
                                ...
                                <div className="mt-10" style={{ 'display': 'flex' }}>
                                    ...
                                    <div className="col-lg-9 col-md-4">
                                        <input type="text" placeholder="Địa chỉ" onFocus="this.placeholder = ''"
                                            onBlur="this.placeholder = 'Địa chỉ'" required className="single-input"
